      ...
      *  'RBK04P01-responseCode200', each of which represents an
      ...
      *  of structure 'RBK04P01-responseCode404', each of which
      ...
      *  of structure 'RBK04P01-authors', each of which represents an
      ...
      *  instances of structure 'RBK04P01-authorsBooks', each of which
      *  represents an instance of JSON schema keyword
      ...
      *  instances of structure 'RBK04P01-authors3', each of which
      *  represents an instance of JSON schema keyword
