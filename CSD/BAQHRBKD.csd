...
DELETE TRANSACTION(PRBK) GROUP(BAQHRBKG)
DEFINE TRANSACTION(PRBK) GROUP(BAQHRBKG)
       DESCRIPTION(Call the patchRedbook (RFC6902) operation of the RedbookAPI)
       PROGRAM(BAQHRBKC)

DELETE TRANSACTION(MRBK) GROUP(BAQHRBKG)
DEFINE TRANSACTION(MRBK) GROUP(BAQHRBKG)
       DESCRIPTION(Call the mergeRedbook (RFC7396) operation of the RedbookAPI)
       PROGRAM(BAQHRBKC)
